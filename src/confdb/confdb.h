...
#define CONFDB_PC_CERT_AUTH_PIN_PROMPT "pin_prompt"
#define CONFDB_PC_CERT_AUTH_KEYPAD_PROMPT "keypad_prompt"
#define CONFDB_PC_CERT_AUTH_USERNAME_HINT "user_name_hint"
