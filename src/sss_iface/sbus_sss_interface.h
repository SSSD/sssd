...
/* Method: sssd.dataprovider.autofsHandler */
#define SBUS_METHOD_SYNC_sssd_dataprovider_autofsHandler(handler, data) ({ \
    SBUS_CHECK_SYNC((handler), (data), uint32_t, const char *, uint16_t*, uint32_t*, const char **); \
    sbus_method_sync("autofsHandler", \
...
#define SBUS_METHOD_ASYNC_sssd_dataprovider_autofsHandler(handler_send, handler_recv, data) ({ \
    SBUS_CHECK_SEND((handler_send), (data), uint32_t, const char *); \
    SBUS_CHECK_RECV((handler_recv), uint16_t*, uint32_t*, const char **); \
    sbus_method_async("autofsHandler", \
        &_sbus_sss_args_sssd_dataprovider_autofsHandler, \
        NULL, \
        _sbus_sss_invoke_in_us_out_qus_send, \
        _sbus_sss_key_us_0_1, \
