...
#define SBUS_METHOD_SYNC_sssd_dataprovider_getAccountDomain(handler, data) ({ \
    SBUS_CHECK_SYNC((handler), (data), uint32_t, uint32_t, const char *, uint32_t, const char **); \
...
#define SBUS_METHOD_SYNC_sssd_dataprovider_getAccountInfo(handler, data) ({ \
    SBUS_CHECK_SYNC((handler), (data), uint32_t, uint32_t, const char *, const char *, const char *, uint32_t); \
...
#define SBUS_METHOD_SYNC_sssd_dataprovider_resolverHandler(handler, data) ({ \
    SBUS_CHECK_SYNC((handler), (data), uint32_t, uint32_t, uint32_t, const char *, uint32_t); \
