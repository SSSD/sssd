...
struct sbus_method_in_ss_out_o_state {
    struct _sbus_sss_invoker_args_ss in;
    struct _sbus_sss_invoker_args_o *out;
};

static void sbus_method_in_ss_out_o_done(struct tevent_req *subreq);

static struct tevent_req *
sbus_method_in_ss_out_o_send
    (TALLOC_CTX *mem_ctx,
     struct sbus_connection *conn,
     sbus_invoker_keygen keygen,
     const char *bus,
     ...
     const char * arg1)
{
    struct sbus_method_in_ss_out_o_state *state;
    struct tevent_req *subreq;
    struct tevent_req *req;
    errno_t ret;

    req = tevent_req_create(mem_ctx, &state, struct sbus_method_in_ss_out_o_state);
    if (req == NULL) {
        DEBUG(SSSDBG_CRIT_FAILURE, "Unable to create tevent request!\n");
        return NULL;
    }

    state->out = talloc_zero(state, struct _sbus_sss_invoker_args_o);
    if (state->out == NULL) {
        DEBUG(SSSDBG_CRIT_FAILURE,
              "Unable to allocate space for output parameters!\n");
        ret = ENOMEM;
    ...
    tevent_req_set_callback(subreq, sbus_method_in_ss_out_o_done, req);
...
static void sbus_method_in_ss_out_o_done(struct tevent_req *subreq)
{
    ...
    req = tevent_req_callback_data(subreq, struct tevent_req);
    state = tevent_req_data(req, struct sbus_method_in_ss_out_o_state);
    ...
    ret = sbus_read_output(state->out, reply, (sbus_invoker_reader_fn)_sbus_sss_invoker_read_o, state->out);
    if (ret != EOK) {
        tevent_req_error(req, ret);
        return;
    }
...
struct tevent_req *
sbus_call_systemd_RestartUnit_send
    (TALLOC_CTX *mem_ctx,
     struct sbus_connection *conn,
     const char *busname,
     const char *object_path,
     ...
     const char * arg_mode)
{
    return sbus_method_in_ss_out_o_send(mem_ctx, conn, NULL,
        busname, object_path, "org.freedesktop.systemd1.Manager", "RestartUnit", arg_name, arg_mode);
}

errno_t
sbus_call_systemd_RestartUnit_recv
    (TALLOC_CTX *mem_ctx,
     struct tevent_req *req,
     const char ** _job)
{
    return sbus_method_in_ss_out_o_recv(mem_ctx, req, _job);
}

struct tevent_req *
sbus_call_systemd_StartUnit_send
    (TALLOC_CTX *mem_ctx,
     struct sbus_connection *conn,
     const char *busname,
     const char *object_path,
...
errno_t
sbus_call_systemd_StartUnit_recv
    (TALLOC_CTX *mem_ctx,
     struct tevent_req *req,
     const char ** _job)
{
...
struct tevent_req *
sbus_call_systemd_StopUnit_send
    (TALLOC_CTX *mem_ctx,
     struct sbus_connection *conn,
     const char *busname,
     const char *object_path,
...
errno_t
sbus_call_systemd_StopUnit_recv
    (TALLOC_CTX *mem_ctx,
     struct tevent_req *req,
     const char ** _job)
{
