...
{
    return sbus_method_in_uusu_out_us_recv(mem_ctx, req, _dp_error, _domain_name);
}
...
sbus_call_dp_dp_getAccountInfo_recv
    (struct tevent_req *req,
     uint32_t* _dp_error)
{
    return sbus_method_in_uusssu_out_u_recv(req, _dp_error);
}
...
sbus_call_dp_dp_getDomains_recv
    (struct tevent_req *req,
     uint32_t* _dp_error)
{
    return sbus_method_in_s_out_u_recv(req, _dp_error);
}
...
sbus_call_dp_dp_hostHandler_recv
    (struct tevent_req *req,
     uint32_t* _dp_error)
{
    return sbus_method_in_ussu_out_u_recv(req, _dp_error);
}
...
sbus_call_dp_dp_resolverHandler_recv
    (struct tevent_req *req,
     uint32_t* _dp_error)
{
    return sbus_method_in_uuusu_out_u_recv(req, _dp_error);
}
...
sbus_call_dp_dp_sudoHandler_recv
    (struct tevent_req *req,
     uint32_t* _dp_error)
{
    return sbus_method_in_raw_out_u_recv(req, _dp_error);
}
