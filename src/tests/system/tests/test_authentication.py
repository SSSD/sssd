...
def test_authentication__default_settings(
...
@pytest.mark.topology(KnownTopologyGroup.AnyProvider)
@pytest.mark.importance("critical")
def test_authentication__change_password(
    client: Client,
...
@pytest.mark.topology(KnownTopologyGroup.AnyProvider)
@pytest.mark.importance("critical")
def test_authentication__change_password_with_complexity_requirement(
    client: Client,
    provider: GenericProvider,
):
    """
...
def test_authentication__change_expired_password(
