...
@pytest.mark.importance("medium")
@pytest.mark.topology(KnownTopology.IPATrustIPA)
def test_ipa_trusts__overrides_domain_template(client: Client, ipa: IPA, trusted: IPA):
    """
    ...
    ipa.user(user1_fqn).iduseroverride().add_override_template(
        "testview1", shell=domain_shell, home=domain_home, domain_name=trusted.domain
    )
...
@pytest.mark.importance("medium")
@pytest.mark.topology(KnownTopology.IPATrustIPA)
def test_ipa_trusts__overrides_global_template(client: Client, ipa: IPA, trusted: IPA):
    """
    ...
    ipa.user(user1_fqn).iduseroverride().add_override_template(
        "testview1", shell=global_shell, home=global_home, global_template=True
    )
...
@pytest.mark.importance("medium")
@pytest.mark.topology(KnownTopology.IPATrustIPA)
def test_ipa_trusts__overrides_domain_and_global_template(client: Client, ipa: IPA, trusted: IPA):
    """
...
@pytest.mark.importance("medium")
@pytest.mark.topology(KnownTopology.IPATrustIPA)
def test_ipa_trusts__overrides_normal_override_and_domain_template(client: Client, ipa: IPA, trusted: IPA):
    """
