...
static void test_sysdb_subdomain_create(void **state)
{
    ...
    ret = sysdb_subdomain_store(test_ctx->tctx->sysdb,
                                ...
                                MPG_DISABLED, NULL, 0, IPA_TRUST_UNKNOWN,
                                NULL);
    ...
    ret = sysdb_subdomain_store(test_ctx->tctx->sysdb,
                                ...
                                MPG_DISABLED, NULL, 1, IPA_TRUST_UNKNOWN,
                                NULL);
    assert_int_equal(ret, EOK);
    ...
    ret = sysdb_subdomain_store(test_ctx->tctx->sysdb,
                                dom1[0], dom1[1], dom1[2], dom1[0], dom1[3],
                                MPG_ENABLED, NULL, 1, IPA_TRUST_UNKNOWN,
                                NULL);
    assert_int_equal(ret, EOK);

    ret = sysdb_subdomain_store(test_ctx->tctx->sysdb,
                                dom2[0], dom2[1], dom2[2], dom2[0], dom2[3],
                                MPG_ENABLED, NULL, 0, IPA_TRUST_UNKNOWN,
                                NULL);
    assert_int_equal(ret, EOK);
    ...
    ret = sysdb_subdomain_store(test_ctx->tctx->sysdb,
                                dom1[0], dom1[1], dom1[2], dom1[0], dom1[3],
                                MPG_HYBRID, NULL, 1, IPA_TRUST_UNKNOWN,
                                NULL);
    assert_int_equal(ret, EOK);

    ret = sysdb_subdomain_store(test_ctx->tctx->sysdb,
                                dom2[0], dom2[1], dom2[2], dom2[0], dom2[3],
                                MPG_HYBRID, NULL, 0, IPA_TRUST_UNKNOWN,
                                NULL);
    assert_int_equal(ret, EOK);
...
static void test_sysdb_link_ad_multidom(void **state)
{
    ...
    ret = sysdb_subdomain_store(main_dom2->sysdb,
                                ...
                                MPG_DISABLED, dom2_forest_root[4], 0, IPA_TRUST_UNKNOWN,
                                NULL);
    assert_int_equal(ret, EOK);
