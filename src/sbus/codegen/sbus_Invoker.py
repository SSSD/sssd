...
class Invoker:
    ...
    def __init__(self, sbus_input, sbus_output):
        ...
        self.output = self.getSignature(sbus_output,
    ...
    def getSignature(self, sbus_signature, is_custom_handler):
        ...
        invoker_signature = "raw" if is_custom_handler else sbus_signature.signature
...
class InvokerKeygen:
    ...
    def BuildKey(sbus_member, sbus_signature, Args = None):
        ...
        """
        args = Args if not None else InvokerKeygen.GatherKeyArguments(sbus_member, sbus_signature)
    ...
    def GatherKeyArguments(sbus_member, sbus_signature):
        ...
        return OrderedDict(sorted(keys.items(),
                                  ...
                                  # key = lambda (idx, arg): arg.key))
                                  # the above does not work in python3
